...
const emit = defineEmits<{
  (e: 'image-select', data: { url: string; pieces: 20 | 30 | 40 }): void
}>()

const fileInput = ref<HTMLInputElement | null>(null)
const isDragging = ref(false)
const previewUrl = ref('')
const selectedPieces = ref<20 | 30 | 40>(20)

const pieceOptions = [
  { count: 20 as const, label: '簡單', emoji: '🌟' },
  { count: 30 as const, label: '中等', emoji: '⭐' },
  { count: 40 as const, label: '困難', emoji: '🔥' },
]
